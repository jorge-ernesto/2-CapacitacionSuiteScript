    ...
    <Table ss:StyleID="background">
      ...
      <Row>
        ...
        <Cell ss:StyleID="cell" ss:MergeAcross="1">
          <Data ss:Type="String">Richard Galvez</Data>
        </Cell>
      </Row>
      <Row>
        <Cell ss:StyleID="t1">
      ...
      <Row>
        <Cell ss:StyleID="cell">
          <Data ss:Type="String">Nro 1</Data>
        </Cell>
        <Cell ss:StyleID="cell">
          <Data ss:Type="String">Ejemplo1</Data>
        </Cell>
        <Cell ss:StyleID="cell">
          <Data ss:Type="String">28/04/2023</Data>
        </Cell>
        <Cell ss:StyleID="cell">
          <Data ss:Type="String">C001</Data>
        </Cell>
        <Cell ss:StyleID="cell">
          <Data ss:Type="String">123456</Data>
        </Cell>
      </Row>
    </Table>
  </Worksheet>
