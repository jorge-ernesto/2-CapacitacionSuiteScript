...
//      - Biomont CS Journal Jorge (customscript_jel_bio_cs_journal)
// - Registro:
//      - Journal (customrecord_jel_alumnos)
...
define(['N'],
    ...
    function (N) {
        ...
        function validateField(scriptContext) {
            ...
            // Validar que sea la sublista 'line'
            if (scriptContext.sublistId == 'line') {

                // Validar que sea el campo 'credit'
                if (scriptContext.fieldId == 'credit') {

                    // Obtener el valor del campo 'credit'
                    let value = recordContext.getCurrentSublistValue('line', 'credit');
                    value = Number(value);

                    // Validar cantidad ingresada
                    if (value > 1000) {
                        alert('El Monto Supera los 1000');
                        return false;
                    }
                }
            }
        ...
        function validateLine(scriptContext) {
            ...
            // Se ejecuta solo al agregar una nueva linea a una sublista o al confirmar una linea existente
        ...
        function saveRecord(scriptContext) {
            ...
            // Obtener la cantidad de detalle de la sublista
            let totalLines = recordContext.getLineCount('line');
